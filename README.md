...
if(lam<mu1) and (lam<mu2) and (lam<mu3): 
    ...
    7print("Average number of objects in the conveyor S2: %0.2f"%Lq2) 
...
<img width="686" height="317" alt="maths ex6" src="https://github.com/user-attachments/assets/d3ee25d1-d427-458e-a094-e4a181887a06" />
